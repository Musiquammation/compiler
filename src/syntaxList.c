...
Token SYNTAXLIST_FREE_INTEGER[] = {
	{.type = TOKEN_CTYPE_INTEGER}
};


Token SYNTAXLIST_MEMBER[] = {
	{.type = TOKEN_CTYPE_LABEL},
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_HASH},
};
...
Token SYNTAXLIST_MEMBER_DEF_ENDING[] = {
...
Token SYNTAXLIST_SINGLETON_LBRACKET[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LBRACKET},
};

Token SYNTAXLIST_SINGLETON_LANGLE[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LANGLE},
};

Token SYNTAXLIST_SINGLETON_RBRACKET[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_RBRACKET},
};
...
Token SYNTAXLIST_SINGLETON_COMMA[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_COMMA},
};

Token SYNTAXLIST_SINGLETON_SCOPE[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_SCOPE},
};

Token SYNTAXLIST_SINGLETON_MEMBER[] = {
...
Token SYNTAXLIST_SETTINGSDECL_SEPARATOR[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_COMMA},
...
Token SYNTAXLIST_FNCALL[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LPAREN},
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LANGLE},
};

Token SYNTAXLIST_CONSTRUCTOR[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LBRACE},
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_COLON},
};

Token SYNTAXLIST_CONSTRUCTOR_ENTER[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LBRACE},
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_COLON},
};

Token SYNTAXLIST_CONSTRUCTOR_START[] = {
	{.type = TOKEN_CTYPE_LABEL},
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_RBRACE},
};
...
Token SYNTAXLIST_ANNOTATIONCONDITION[] = {
	{.type = TOKEN_CTYPE_LABEL},
	{.type = TOKEN_CTYPE_INTEGER}
};

Token SYNTAXLIST_ANNOTATION_PROJECT[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_RPAREN},
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_COLON},
};

Token SYNTAXLIST_START_IF[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LPAREN},
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LBRACKET},
};

Token SYNTAXLIST_INTERPRETED_IF_TEST[] = {
	{.type = TOKEN_CTYPE_LABEL},	
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LOGICAL_NOT},
};


Token SYNTAXLIST_INTERPRETED_IF_CONJONCTION[] = {
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_RBRACKET},
	{.type = TOKEN_CTYPE_OPERATOR, .operator = TOKEN_OPERATOR_LOGICAL_AND},
};
...
Token SYNTAXLIST_EXPRESSION[] = {
	...
	op(TOKEN_OPERATOR_RBRACE),
	op(TOKEN_OPERATOR_RBRACKET),
	...
	op(TOKEN_OPERATOR_LANGLE),
	op(TOKEN_OPERATOR_LE),
	op(TOKEN_OPERATOR_RANGLE),
...
void syntaxList_init(void) {
	...
	init(SYNTAXLIST_FREE_INTEGER);
	init(SYNTAXLIST_MEMBER);
	...
	init(SYNTAXLIST_START_TYPE);
	init(SYNTAXLIST_CONSTRUCTOR_START);
	init(SYNTAXLIST_MEMBER_DEF_ENDING);
	init(SYNTAXLIST_TYPE);
	init(SYNTAXLIST_ARGS);
	init(SYNTAXLIST_ARGS_ENDING);
	...
	init(SYNTAXLIST_SINGLETON_LBRACKET);
	init(SYNTAXLIST_SINGLETON_RBRACKET);
	init(SYNTAXLIST_SINGLETON_LBRACE);
	init(SYNTAXLIST_SINGLETON_RBRACE);
	init(SYNTAXLIST_SINGLETON_COMMA);
	init(SYNTAXLIST_FNCALL);
	init(SYNTAXLIST_CONSTRUCTOR);
	...
	init(SYNTAXLIST_SETTINGSDECL_SEPARATOR);
	init(SYNTAXLIST_CONTINUE_FNCALL);
	init(SYNTAXLIST_SETTING);
	init(SYNTAXLIST_FN_SETTING);
	init(SYNTAXLIST_ANNOTATIONCONDITION);
	init(SYNTAXLIST_ANNOTATION_PROJECT);
	init(SYNTAXLIST_START_IF);
	init(SYNTAXLIST_INTERPRETED_IF_TEST);
	init(SYNTAXLIST_INTERPRETED_IF_CONJONCTION);
}
