...
enum {
	...
	SYNTAXDATAFLAG_FNDCL_CONSTRUCTOR = 1<<9,
	SYNTAXDATAFLAG_FNDCL_ARGUMENT_CONSTRUCTOR = 1<<10,
	SYNTAXDATAFLAG_FNDCL_TEST = 1<<11,
	SYNTAXDATAFLAG_FNDCL_CONDITION = 1<<12,
	SYNTAXDATAFLAG_FNDCL_CREATE_THIS = 1<<13,
...
void Syntax_annotation(Annotation* annotation, Parser* parser,
	LabelPool* labelPool, Scope* scope);
